...
<img src="../../assets/caratula/upc-logo.png" alt="Logo UPC" width="150">
...
<h4>NRC 12305</h4>
<h4>Docente: Noriega Melendez, Julio Manuel </h4>
<h4>Informe de Trabajo Final</h4>
<h4>Startup: Energix</h4>
<h4>Producto: Smart Energy Management System (SEMS)</h4>
...
**Link de la organización:** https://github.com/EnergixUPC

**Link del Repositorio del Informe:** https://github.com/EnergixUPC/Reporte

### Reporte de Colaboración para la Entrega del TB1

En esta primera el equipo llevó a cabo diversas actividades correspondiente a la Parte 1: As-Is Software Project.
...
- [Capítulo III: Requirements Specification](#capitulo-iii-requirements-specification)
    ...
    - [3.2. User Stories](#31-user-stories)
    - [3.3. Product Backlog](#33-product-backlog)
    - [3.4. Impact Mapping](#32-impact-mapping)
...
- Part II: Verification, Validation & Pipeline
  - [Capítulo VI: Product Verification & Validation](./Capitulo_6_Product_Verification_Validation/README.md)
  ...
  - [Capítulo VII: DevOps Practices](./Capitulo_7_DevOps_Practices/README.md)
...
- Part III: Experiment-Driven Lifecycle
  - [Capítulo VIII: Experiment-Driven Development](./Capitulo_8_Experiment_Driven_Development/README.md)
...
|--------------------------|-------------------------|------------------|
| **Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software** | **Huaman Olivos, Yeira Shari**<br>**TP1**<br> - Estableció las convenciones de código y estándares de calidad mediante pruebas unitarias y de integración, garantizando la fiabilidad y profesionalismo del software.<br><br>**Torres Lavandera, Andrés Rodrigo**<br>**TP1**<br>- Definió historias de usuario y criterios de aceptación orientados a la transparencia y la calidad mediante pruebas automatizadas y BDD.<br><br>**Acuña Corahua, Jonatan Ariel**<br>**TP1**<br>- Configuró los pipelines de entrega y despliegue continuo (CI/CD), asegurando el versionamiento del código y un desarrollo profesional seguro y rastreable.<br><br>**Meza Solórzano, Didier Sebastian**<br>**TP1**<br>- Redactó el Acuerdo de Servicio SaaS y la documentación formal de la API (Swagger), promoviendo la transparencia legal y ética en el uso de la plataforma.<br><br>**Duran Díaz, Antonio Rodrigo**<br>**TP1**<br>- Durante el desarrollo del informe consideré la importancia de usar la información de manera responsable y ética durante la recolección de datos en las entrevistas.<br><br>**Teves Samaniego, Joan Fernando**<br>**TP1**<br>- Diseñó la arquitectura de la información asegurándose de proveer una interfaz accesible y guiada por estándares de diseño profesional y ético. | El equipo de desarrollo ha demostrado su compromiso con la responsabilidad técnica y ética, fomentando la calidad del código, asegurando la confiabilidad a través de testing automatizado y garantizando la transparencia del servicio mediante una adecuada documentación legal y técnica. |
| **Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales** | **Huaman Olivos, Yeira Shari**<br>**TP1**<br> - Evaluó herramientas de despliegue y repositorios, promoviendo la eficiencia técnica para el ahorro de recursos en un contexto tecnológico.<br><br>**Torres Lavandera, Andrés Rodrigo**<br>**TP1**<br>- Realizó un mapeo de impacto y escenarios "To-Be" evaluando las implicaciones sociales y las mejoras de calidad de vida que proporcionará la solución.<br><br>**Acuña Corahua, Jonatan Ariel**<br>**TP1**<br>- Contextualizó el proyecto definiendo el perfil del startup y el modelo de solución, analizando el contexto social que originó la oportunidad en el mercado.<br><br>**Meza Solórzano, Didier Sebastian**<br>**TP1**<br>- Implementó y documentó las interfaces web, demostrando el impacto directo de la plataforma para mejorar el acceso digital de los usuarios en diversos sectores sociales.<br><br>**Duran Díaz, Antonio Rodrigo**<br>**TP1**<br>- Participando con el avance del informe se analizó cómo la solución propuesta puede influir en los usuarios y su entorno de manera positiva, mediante el análisis de competidores.<br><br>**Teves Samaniego, Joan Fernando**<br>**TP1**<br>- Desarrolló el diseño del producto enfocándose en proporcionar interfaces inclusivas que faciliten el acceso tecnológico en contextos diversos. | El grupo ha evidenciado la capacidad de dimensionar el impacto social, económico y global de la plataforma Energix, respaldando sus decisiones en análisis de mercado, diseño inclusivo y en el despliegue de soluciones accesibles y escalables que resuelven problemas reales y mejoran el entorno de los usuarios. |
...
Somos Energix, un Startup conformado por estudiantes de la Universidad Peruana de Ciencias Aplicadas (UPC) con el objetivo de crear una plataforma que contribuya a la optimización del consumo energético y que genere un impacto positivo en la economía de hogares en zonas residenciales de Lima, Perú, que cuentan con acceso a electricidad y múltiples artefactos electrónicos.
...
<img src="../../assets/capitulo-1/energix-logo.png" alt="Logo de Energix" width="200"/>

### 1.1.2. Perfiles de integrantes del equipo

| Nombre                                                            | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|-------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![Yeira-Huaman.jpeg](../../assets/capitulo-1/Yeira-Huaman.jpeg)Yeira Shari         | Mi nombre es Yeira Shari Huaman Olivos y tengo 20 años. Actualmente, curso el 5to ciclo de la carrera Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas, donde me he desarrollado como una persona responsable, participativa y con una gran pasión por el trabajo en equipo. En este proyecto, mi objetivo es contribuir con mis conocimientos y habilidades técnicas en lenguajes como C++, Python, CSS, HTML, SQL, así como en el uso de Figma, para alcanzar los objetivos del equipo.                                                                                            |
| ![Jonatan-Acuña.jpg](../../assets/capitulo-1/Jonatan-Acuna.png)Jonatan Acuña        | Soy estudiante de la carrera de Ingeniería de Software en la UPC. Me gustó la carrera tras aprender desarrollo web y desde entonces, sigo aprendiendo para mejorar mis habilidades cada vez más. Me gusta aprender sobre las nuevas tecnologías de la web, jugar videojuegos y de vez en cuando salir en bicicleta. |
| ![Didier-Meza.jpeg](../../assets/capitulo-1/Didier-Meza.jpeg) Didier Meza      | Soy estudiante de Ingeniería de Software en 7mo ciclo, con conocimientos en desarrollo backend y frontend. Manejo tecnologías como C + +, JavaScript, HTML y frameworks modernos, aplicando buenas prácticas como programación orientada a objetos, Clean Architecture & Domain-Driven Design (DDD). Me adapto con facilidad al trabajo en equipo y tengo una fuerte orientación a resultados. Aportó al equipo proponiendo soluciones prácticas, optimizando procesos y enfocándome en generar valor para el usuario final.                                                                      |
  | ![Antonio-Duran.png](../../assets/capitulo-1/Antonio-Duran.png) Antonio Duran          | Soy estudiante de la carrera de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas. En este proyecto espero seguir mejorando mis habilidades y conocimientos, además de lograr un buen desempeño en el trabajo grupal                                                                                                                                                                                          |
| ![Andrés-Torres.png](../../assets/capitulo-1/Andr%C3%A9s-Torres.png) Andrés Rodrigo | Mi nombre es Andrés Torres, actualmente tengo 19 años y estoy cursando el sexto ciclo de la carrera Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas. Considero que tengo buen nivel en el lenguaje de programación de C++ y un nivel básico en Python. Además, soy un alumno responsable y que aporta en los trabajos grupales. Estoy totalmente dispuesto a colaborar con mi grupo para realizar un muy buen trabajo de curso.                                                                                                                                                     |
| ![Joan Teves.jpg](../../assets/capitulo-1/Joan-Teves.jpeg) Joan Teves                      | Soy estudiante de ciclos superiores de Ingeniería de Software en la UPC. Me destaco como desarrollador full-stack con amplia experiencia en frameworks como Vue.js, Astro, Django y FastAPI. Actualmente formo parte de Huawei como practicante pre-profesional en el rol de SEC Trainee. En este proyecto, busco aportar mi visión técnica y arquitectónica para desarrollar una solución robusta y escalable.                                                                                                                                                                                                                                                                                                                                                             |
...
| **Where (Dónde)**   | La problemática se presenta principalmente en zonas residenciales de Lima, Perú, en hogares con acceso a servicios de electricidad y múltiples dispositivos, donde muchos no cuentan con herramientas para gestionar su consumo eléctrico.     |
...
- Nuestros usuarios iniciales son (o serán):
  propietarios o inquilinos de viviendas (casas o apartamentos) en zonas residenciales de Lima, Perú, con acceso estable a electricidad, múltiples dispositivos y a internet, que estén interesados en ser más sostenibles y, sobre todo, en ahorrar dinero en sus facturas de electricidad.
...
- ¿Quién es el usuario?
  propietarios e inquilinos de viviendas en zonas residenciales de Lima, Perú, provistos de acceso a luz y dispositivos, con facturas eléctricas elevadas, preocupados por el constante aumento de costos energéticos y que buscan reducir gastos domésticos de manera práctica y tecnológica.
...
| **Geográfica**                | Ubicación: Zonas residenciales de Lima, Perú, con acceso a luz y múltiples dispositivos en el hogar. Tipo de residencia: Casas unifamiliares, condominios o departamentos de propiedad.                                                                                                                  | Ubicación: Zonas residenciales de Lima, Perú, cerca de sus centros de estudio, con acceso a luz y dispositivos. Tipo de residencia: Departamentos, estudios o casas compartidas en alquiler.                                                                                                                                     |
...
## Lupbak
<img src="../../assets/capitulo-2/lupbak-logo.png" alt="LupBak Logo" width="150"/>
...
## Refoss
<img src="../../assets/capitulo-2/refoss-logo.png" alt="Refoss Logo" width="150"/>
...
<img src="../../assets/capitulo-2/EIP-logo.png" alt="Espacios Inteligentes Perú Logo" width="200"/>
...
<table border="1px">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="9">Identificar fortalezas, debilidades y oportunidades de diferenciación en el mercado de monitoreo energético doméstico, para posicionar estratégicamente Energix y maximizar su ventaja competitiva.</td> 
            </tr>
            <tr>
                <tr>
                    <td colspan="3"></td>
                    <td colspan="2"><img src="../../assets/capitulo-2/energix-logo.png" style="width: 60px; height: auto;"><br>Energix</td>
                    <td colspan="2"><img src="../../assets/capitulo-2/lupbak-logo.png" style="width: 60px; height: auto;"><br>LupBak</td>
                    <td colspan="2"><img src="../../assets/capitulo-2/refoss-logo.png" style="width: 60px; height: auto;"><br>Refoss</td>
                    <td colspan="2"><img src="../../assets/capitulo-2/EIP-logo.png" style="width: 60px; height: auto;"><br>Espacios Inteligentes Perú</td>
                </tr>
            </tr>
            <tr>
                <td rowspan="2" colspan="1">Perfil</td>
                <td colspan="2">Overview</td>
                <td colspan="2">Startup peruana que ofrece monitoreo energético en tiempo real con medidor inteligente, alertas automáticas y control remoto de dispositivos.</td>
                <td colspan="2">Plataforma que convierte hogares en entornos energéticamente inteligentes usando sensores conectados.</td>
                <td colspan="2">Proveedor de medidores inteligentes con aplicación para análisis detallados del consumo energético.</td>
                <td colspan="2">Empresa peruana especializada en automatización del hogar con servicios de instalación profesional.</td>
            </tr>
            <tr>
                <td colspan="2"> Ventaja competitiva <br></br> ¿Qué valor ofrece a los clientes?</td>
                <td colspan="2">• Enfoque en ahorro económico directo (20-30%)<br>• Control remoto de dispositivos<br>• Interfaz simple y amigable<br>• Alertas predictivas</td>
                <td colspan="2">• Ecosistema completo de sensores<br>• Automatización integral del hogar<br>• Recomendaciones personalizadas avanzadas</td>
                <td colspan="2">• Análisis técnicos detallados<br>• Precisión en mediciones<br>• Enfoque en datos granulares</td>
                <td colspan="2">• Conocimiento del mercado local<br>• Servicios profesionales de instalación<br>• Soporte técnico presencial</td>
            </tr>
            <tr>
                <td rowspan="2" colspan="1">Perfil de Marketing</td>
                <td colspan="2">Mercado Objetivo</td>
                <td colspan="2">Amas de casa, propietarios con múltiples dispositivos, estudiantes que alquilan (usuarios conscientes del gasto).</td>
                <td colspan="2">Propietarios de viviendas interesados en hogar inteligente completo</td>
                <td colspan="2">Usuarios técnicos que buscan datos detallados de consumo</td>
                <td colspan="2">Propietarios de viviendas premium que buscan automatización completa</td>
            </tr>
            <tr>
                <td colspan="2">Estrategia de Marketing</td>
                <td colspan="2"> • Enfoque en ahorro económico<br>• Marketing digital dirigido<br>• Demostraciones de ROI<br>• Testimonios de usuarios</td>
                <td colspan="2">• Marketing de hogar inteligente<br>• Enfoque en innovación tecnológica<br>• Partnerships con fabricantes</td>
                <td colspan="2"> • Marketing técnico especializado<br>• Comunidades de usuarios tech<br>• Contenido educativo técnico</td>
                <td colspan="2">• Marketing local B2B y B2C<br>• Showrooms físicos<br>• Referencias y recomendaciones</td>
            </tr>
            <tr>
                <td rowspan="3" colspan="1">Perfil de Producto</td>
                <td colspan="2">Producto & Servicio</td>
                <td colspan="2">• Medidor inteligente<br>• Plataforma web de monitoreo<br>• Alertas automáticas<br>• Control remoto de dispositivos<br>• Reportes semanales</td>
                <td colspan="2"> • Múltiples sensores conectados<br>• Plataforma de automatización<br>• Recomendaciones IA<br>• Integración con otros dispositivos</td>
                <td colspan="2"> • Medidores inteligentes<br>• Aplicación móvil<br>• Análisis detallados<br>• Sistema de alertas</td>
                <td colspan="2">• Dispositivos de automatización<br>• Servicios de instalación<br>• Configuración personalizada<br>• Soporte técnico</td>
            </tr>
            <tr>
                <td colspan="2">Precio & Costos  </td>
                <td colspan="2">Modelo freemium con suscripción mensual para funciones avanzadas (estimado: S/50-80/mes)</td>
                <td colspan="2">Inversión inicial alta por múltiples sensores + suscripción mensual</td>
                <td colspan="2">Costo del medidor + aplicación gratuita o premium</td>
                <td colspan="2">Costo de dispositivos + instalación profesional + mantenimiento</td>
            </tr>
            <tr>
                <td colspan="2">Canales de distribucion (web y/o Movil)</td>
                <td colspan="2">• Plataforma web propia<br>• App móvil<br>• Tiendas online<br>• Instalación autoguiada</td>
                <td colspan="2">• Plataforma web<br>• App móvil<br>• Retailers especializados<br>• E-commerce</td>
                <td colspan="2">• Tiendas especializadas<br>• E-commerce<br>• Distribuidores técnicos</td>
                <td colspan="2">• Venta directa<br>• Showrooms físicos<br>• Instaladores certificados<br>• Website corporativo</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">• Enfoque específico en ahorro económico<br>• Interfaz simple y amigable<br>• Control remoto de dispositivos<br>• Enfoque Lean UX<br>• Conocimiento del mercado peruano</td>
                <td colspan="2">• Ecosistema completo de sensores<br>• Tecnología avanzada<br>• Recomendaciones personalizadas<br>• Marca establecida</td>
                <td colspan="2">• Precisión técnica<br>• Análisis detallados<br>• Experiencia en medidores<br>• Base de usuarios técnicos</td>
                <td colspan="2">• Presencia local establecida<br>• Servicios profesionales<br>• Conocimiento del mercado peruano<br>• Red de instaladores</td>
            </tr>
            <tr>
                <td colspan="2">Debilidades</td>
                <td colspan="2">• Startup nueva sin track record<br>• Recursos limitados<br>• Dependencia de adopción tecnológica<br>• Necesidad de validación en mercado</td>
                <td colspan="2"> • Mayor complejidad de uso<br>• Costo inicial alto<br>• Puede ser percibido como complicado</td>
                <td colspan="2">• Enfoque muy técnico<br>• Barrera de entrada para usuarios básicos<br>• Menos enfoque en UX</td>
                <td colspan="2">• Costos altos de instalación<br>• Dependencia de servicios presenciales<br>• Menor escalabilidad</td>
            </tr>
            <tr>
                <td colspan="2">Oportunidades</td>
                <td colspan="2">• Creciente conciencia sobre ahorro energético<br>• Aumento de tarifas eléctricas<br>• Digitalización acelerada<br>• Mercado peruano sin líder claro<br>• Segmento de usuarios conscientes del gasto</td>
                <td colspan="2">• Expansión a mercados emergentes<br>• Integración con más dispositivos IoT<br>• Partnerships estratégicos</td>
                <td colspan="2">• Simplificación de interfaz<br>• Expansión a mercado residencial masivo<br>• Reducción de costos</td>
                <td colspan="2">• Expansión nacional<br>• Digitalización de servicios<br>• Partnerships con constructoras</td>
            </tr>
            <tr>
                <td colspan="2">Amenazas</td>
                <td colspan="2">• Competidores con mayor capital<br>• Resistencia al cambio tecnológico<br>• Regulaciones energéticas cambiantes<br>• Entrada de grandes tech companies</td>
                <td colspan="2">• Competencia de gigantes tecnológicos<br>• Commoditización de sensores IoT<br>• Cambios en estándares de conectividad</td>
                <td colspan="2">• Nuevas tecnologías disruptivas<br>• Competencia de soluciones más simples<br>• Cambios regulatorios</td>
                <td colspan="2">• Digitalización del mercado<br>• Competencia de soluciones DIY<br>• Reducción de márgenes por competencia</td>
            </tr>
        </tbody>
    </table>
...
La "User Person" de Jane Smith representa a propietarios de vivienda que desean tener una herramienta que les ayude a optimizar su consumo de energía en sus hogares. Jane es una secretaria de 35 años, motivado por las nuevas tecnologías y la rapidez de la evolución de estas mismas las cuales le ayudarán en su desempeño como secretaria. Las frustraciones que presenta son el elevado monto de la factura que recibe cada mes debido al alto consumo energético que genera día a día y el no tener una herramienta que le ayude a optimizar este consumo. 
    ![User-Person-1.png](../../assets/capitulo-2/User-Person-1.png)
#
- **User Persona para Estudiantes**
  ...
  La "User Person" de Marío Nuñez representa a los estudiantes que alquilan viviendas. Interesados en reducir su consumo energético para poder ahorrar dinero para sus demás necesidades. Marío Nuñez de 20 años es un estudiante de la carrera de ingenieria de software, utiliza herrameientas tecnológicas de modernas debido a que su carre lo demanda. Sus motivaciones son poder disminuir el consumo energético generado cada mes. Sus frustaciones son los elevados costos de la factura de luz lo que le obliga a gastar de más del preosupuesto que tenía para el mes.
    ![User-Person-2.png](../../assets/capitulo-2/User-Person-2.png)
